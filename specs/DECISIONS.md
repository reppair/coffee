...
|---|------|----------|-----------|
| 001 | 2026-02-08 | Products inherit description from category — no `description` column on products | Avoids duplication; products in same category share context |
